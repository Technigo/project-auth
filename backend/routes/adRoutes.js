...
router.post("/createAd", authenticateUser, createAdController); // When a POST request is made to /add, authenticate the user using middleware and then execute the addAdController function
