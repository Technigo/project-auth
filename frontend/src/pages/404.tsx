  ...
  return (
    <div className="w-full h-screen flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0 bg-yellow-100">
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
        ...
        <p className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-wider text-green-700 mt-2">
          Page Not Found
        </p>
        ...
        <button
          onClick={() => navigate(-1)}
          className=" cursor-pointer flex items-center space-x-2 bg-green-600 hover:bg-green-700 text-yellow-100 px-4 py-2 rounded transition duration-150"
          title="Return Home"
        >
          <svg
      ...
      <div className="w-1/2 lg:h-full flex lg:items-end justify-center p-4">
        ...
        >
          ...
          <circle cx="212.59226" cy="103" r="64" fill="#fa7d3f"></circle>
          <path
