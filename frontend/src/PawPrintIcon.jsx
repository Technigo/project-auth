export const PawPrintIcon = ({ fill = "#ffff" }) => (
  <svg
    ...
    <metadata>
      <rdf:RDF>
        <cc:Work>
          ...
          <dc:title>Paw Print</dc:title>
          <dc:date>2011-06-05T04:06:25</dc:date>
          <dc:description>A simple paw print</dc:description>
          <dc:source>
            https://openclipart.org/detail/142447/paw-print-by-kattekrab
          </dc:source>
          <dc:creator>
            <cc:Agent>
              <dc:title>kattekrab</dc:title>
            </cc:Agent>
          </dc:creator>
          <dc:subject>
            <rdf:Bag>
              <rdf:li>animal</rdf:li>
              <rdf:li>animal foot print</rdf:li>
              <rdf:li>black</rdf:li>
